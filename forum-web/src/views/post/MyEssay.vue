    ...
    <div class="ywzs_w">
      <div class="header-top">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>我的成果</el-breadcrumb-item>
        </el-breadcrumb>
...
<!--                  <li><em>{{ item.viewCount }}</em>阅读</li>-->
                  ...
                  <li v-if="item.publishStatus == 0">草稿</li>
                  <li v-else>已发布</li>
                </ul>
                <p class="fr">
      ...
      <div class="ywzs_wright">
        <div class="ywzs_creative">
          ...
          <ul class="ywzs_creativetool">
            <li><em class="czicon_shoucang" @click="toRouter('/collection')"></em>收藏</li>
