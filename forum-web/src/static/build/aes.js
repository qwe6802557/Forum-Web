...
function onbtnEncrypto(word,secret) {
    ...
    var encryptedData = encrypted.toString().myReplace('\/','-');
    encryptedData = encryptedData.toString().myReplace('\=','.');
   /*  encryptedData = encryptedData.ciphertext.toString(); */
    /* document.getElementById("output").value = encryptedData; */
    encryptedData = encryptedData.toString().myReplace('\\+','_');
    encryptedData = ToUTF8(encryptedData);
